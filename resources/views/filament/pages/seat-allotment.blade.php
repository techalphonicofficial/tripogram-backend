                                        ...
                                        <tr class="{{ $isFullyFilled ? 'row-filled' : 'row-unfilled' }}">
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $booking['phone']) }}?text={{ urlencode('Pending booking #'.$booking['id'].' - '.($isFullyFilled ? 'Ready for seat selection' : 'Please complete your details').' Please fill your details on this link: https://enlive-trips.vercel.app/booking-detail?id='.($booking['booking_token'] ?? 'null')) }}" class="whatsapp-btn" target="_blank" title="Send WhatsApp message">
